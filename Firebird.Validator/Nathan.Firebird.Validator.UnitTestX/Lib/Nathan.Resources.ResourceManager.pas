...
type
  ...
  public
    ...
    class procedure SaveResource(const ResName, SaveToFilename: string; const ResType: PChar); static;
    class procedure SaveToFile(const ResName, SaveToFilename: string; const ResType: PChar); static;
  end;
